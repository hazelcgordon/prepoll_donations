...
pp2024_4 <- read.csv("data/prepoll4_2024.csv")
pp2024_5 <- read.csv("data/prepoll5_2024.csv")
pp2024_6 <- read.csv("data/prepoll6_2024.csv")

#combine

pp2024 <- rbind(pp2024, pp2024_2, pp2024_3, pp2024_4, pp2024_5, pp2024_6)
...
pp2024$DonorStatus <- gsub("Registered Political Party", "Political Party", pp2024$DonorStatus)
...
pp2024$DonorStatus <- factor(pp2024$DonorStatus, levels = c("Individual", "Company", "Trade Union", "Unincorporated Association", "Political Party", "Friendly Society"))

pp2024$ReportingPeriodName <- factor(pp2024$ReportingPeriodName, levels = c("Pre-Poll 1 - Party(30/05/24 - 05/06/24) UKPGE 2024", "Pre-Poll 2 - Party(06/06/24 - 12/06/24) UKPGE 2024", "Pre-Poll 3 - Party(13/06/24 - 19/06/24) UKPGE 2024", "Pre-Poll 4 - Party(20/06/24 - 26/06/24) UKPGE 2024", "Pre-Poll 5 - Party(27/06/24 - 03/07/24) UKPGE 2024", "Pre-Poll 6 - Party(04/07/24 - 04/07/24) UKPGE 2024"))
...
donor_statuses <- c('Individual', 'Company', 'Trade Union', 'Unincorporated Association', 'Political Party', 'Friendly Society')

reporting_periods <- c('Pre-Poll 1 - Party(30/05/24 - 05/06/24) UKPGE 2024', 'Pre-Poll 2 - Party(06/06/24 - 12/06/24) UKPGE 2024', 'Pre-Poll 3 - Party(13/06/24 - 19/06/24) UKPGE 2024', 'Pre-Poll 4 - Party(20/06/24 - 26/06/24) UKPGE 2024', 'Pre-Poll 5 - Party(27/06/24 - 03/07/24) UKPGE 2024', 'Pre-Poll 6 - Party(04/07/24 - 04/07/24) UKPGE 2024')
...
pp_complete <- pp_complete %>%
  select(RegulatedEntityName, `Individual_Pre-Poll 1 - Party(30/05/24 - 05/06/24) UKPGE 2024`, `Individual_Pre-Poll 2 - Party(06/06/24 - 12/06/24) UKPGE 2024`, `Individual_Pre-Poll 3 - Party(13/06/24 - 19/06/24) UKPGE 2024`, `Individual_Pre-Poll 4 - Party(20/06/24 - 26/06/24) UKPGE 2024`, `Individual_Pre-Poll 5 - Party(27/06/24 - 03/07/24) UKPGE 2024`, `Individual_Pre-Poll 6 - Party(04/07/24 - 04/07/24) UKPGE 2024`, `Company_Pre-Poll 1 - Party(30/05/24 - 05/06/24) UKPGE 2024`, `Company_Pre-Poll 2 - Party(06/06/24 - 12/06/24) UKPGE 2024`, `Company_Pre-Poll 3 - Party(13/06/24 - 19/06/24) UKPGE 2024`, `Company_Pre-Poll 4 - Party(20/06/24 - 26/06/24) UKPGE 2024`, `Company_Pre-Poll 5 - Party(27/06/24 - 03/07/24) UKPGE 2024`, `Company_Pre-Poll 6 - Party(04/07/24 - 04/07/24) UKPGE 2024`, `Trade Union_Pre-Poll 1 - Party(30/05/24 - 05/06/24) UKPGE 2024`, `Trade Union_Pre-Poll 2 - Party(06/06/24 - 12/06/24) UKPGE 2024`, `Trade Union_Pre-Poll 3 - Party(13/06/24 - 19/06/24) UKPGE 2024`, `Trade Union_Pre-Poll 4 - Party(20/06/24 - 26/06/24) UKPGE 2024`, `Trade Union_Pre-Poll 5 - Party(27/06/24 - 03/07/24) UKPGE 2024`, `Trade Union_Pre-Poll 6 - Party(04/07/24 - 04/07/24) UKPGE 2024`, `Political Party_Pre-Poll 1 - Party(30/05/24 - 05/06/24) UKPGE 2024`, `Political Party_Pre-Poll 2 - Party(06/06/24 - 12/06/24) UKPGE 2024`, `Political Party_Pre-Poll 3 - Party(13/06/24 - 19/06/24) UKPGE 2024`, `Political Party_Pre-Poll 4 - Party(20/06/24 - 26/06/24) UKPGE 2024`, `Political Party_Pre-Poll 5 - Party(27/06/24 - 03/07/24) UKPGE 2024`, `Political Party_Pre-Poll 6 - Party(04/07/24 - 04/07/24) UKPGE 2024`, `Unincorporated Association_Pre-Poll 1 - Party(30/05/24 - 05/06/24) UKPGE 2024`, `Unincorporated Association_Pre-Poll 2 - Party(06/06/24 - 12/06/24) UKPGE 2024`, `Unincorporated Association_Pre-Poll 3 - Party(13/06/24 - 19/06/24) UKPGE 2024`, `Unincorporated Association_Pre-Poll 4 - Party(20/06/24 - 26/06/24) UKPGE 2024`, `Unincorporated Association_Pre-Poll 5 - Party(27/06/24 - 03/07/24) UKPGE 2024`, `Unincorporated Association_Pre-Poll 6 - Party(04/07/24 - 04/07/24) UKPGE 2024`, `Friendly Society_Pre-Poll 1 - Party(30/05/24 - 05/06/24) UKPGE 2024`, `Friendly Society_Pre-Poll 2 - Party(06/06/24 - 12/06/24) UKPGE 2024`, `Friendly Society_Pre-Poll 3 - Party(13/06/24 - 19/06/24) UKPGE 2024`, `Friendly Society_Pre-Poll 4 - Party(20/06/24 - 26/06/24) UKPGE 2024`, `Friendly Society_Pre-Poll 5 - Party(27/06/24 - 03/07/24) UKPGE 2024`, `Friendly Society_Pre-Poll 6 - Party(04/07/24 - 04/07/24) UKPGE 2024`)
...
col_names <- c("Party", rep(c("W1", "W2", "W3", "W4", "W5", "W6"), times = 6), "")

# Summary table
pp_complete %>%
  kable("html", col.names = col_names, align = 'c') %>%
  add_header_above(c(" " = 1, "Individual" = 6, "Company" = 6, "Trade Union" = 6, "Political Party" = 6, "Unincorporated Association" = 6, "Friendly Society" = 6, "Total" = 1)) %>%
...
pptotal <- rbind(pp2019, pp2024, pp2024_2, pp2024_3, pp2024_4, pp2024_5, pp2024_6)
...
pptotal$RegulatedEntityName <- gsub("Advance Together \\[De-registered 01/10/20\\]", "Advance Together", pptotal$RegulatedEntityName)

pptotal$DonorStatus <- gsub("Registered Political Party", "Political Party", pptotal$DonorStatus)
pptotal$DonorStatus <- gsub("Limited Liability Partnership", "LLP", pptotal$DonorStatus)
...
pptotal$RegulatedEntityName <- factor(pptotal$RegulatedEntityName, levels = c("Conservative Party", "Labour Party", "Liberal Democrats", "Reform UK", "SNP", "Green Party", "Plaid Cymru", "Climate Party", "Social Democratic Party", "Workers Party of Britain", "Alliance", "Renew", "Advance Together"))

pptotal$DonorStatus <- factor(pptotal$DonorStatus, levels = c("Individual", "Company", "Trade Union", "Political Party", "Unincorporated Association", "Friendly Society", "LLP"))

pptotal$ReportingPeriodName <- factor(pptotal$ReportingPeriodName, levels = c("Pre-Poll 1 - Party(06/11/19 - 12/11/19) UKPGE 2019", "Pre-Poll 1 - Party(30/05/24 - 05/06/24) UKPGE 2024", "Pre-Poll 2 - Party(13/11/19 - 19/11/19) UKPGE 2019", "Pre-Poll 2 - Party(06/06/24 - 12/06/24) UKPGE 2024", "Pre-Poll 3 - Party(20/11/19 - 26/11/19) UKPGE 2019", "Pre-Poll 3 - Party(13/06/24 - 19/06/24) UKPGE 2024", "Pre-Poll 4 - Party(27/11/19 - 03/12/19) UKPGE 2019", "Pre-Poll 4 - Party(20/06/24 - 26/06/24) UKPGE 2024", "Pre-Poll 5 - Party(04/12/19 - 10/12/19) UKPGE 2019", "Pre-Poll 5 - Party(27/06/24 - 03/07/24) UKPGE 2024", "Pre-Poll 6 - Party(11/12/19 - 12/12/19) UKPGE 2019", "Pre-Poll 6 - Party(04/07/24 - 04/07/24) UKPGE 2024"))
...
prepoll_comparison <- prepoll_comparison %>%
  rename(`Week 1 2019` = `Pre-Poll 1 - Party(06/11/19 - 12/11/19) UKPGE 2019`,
         ...
         `Week 4 2019` = `Pre-Poll 4 - Party(27/11/19 - 03/12/19) UKPGE 2019`,
         `Week 4 2024` = `Pre-Poll 4 - Party(20/06/24 - 26/06/24) UKPGE 2024`, 
         `Week 5 2019` = `Pre-Poll 5 - Party(04/12/19 - 10/12/19) UKPGE 2019`, 
         `Week 5 2024` = `Pre-Poll 5 - Party(27/06/24 - 03/07/24) UKPGE 2024`,
         `Week 6 2019` = `Pre-Poll 6 - Party(11/12/19 - 12/12/19) UKPGE 2019`,
         `Week 6 2024` = `Pre-Poll 6 - Party(04/07/24 - 04/07/24) UKPGE 2024`)

# reorder columns

prepoll_comparison <- prepoll_comparison %>%
  select(RegulatedEntityName, `Week 1 2019`, `Week 1 2024`, `Week 2 2019`, `Week 2 2024`, `Week 3 2019`, `Week 3 2024`, `Week 4 2019`, `Week 4 2024`, `Week 5 2019`, `Week 5 2024`, `Week 6 2019`, `Week 6 2024`)
...
totals_comparison <- kable(prepoll_comparison, col.names = c("", "2019", "2024", "2019", "2024", "2019", "2024", "2019", "2024", "2019", "2024", "2019", "2024"), align = 'c') %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = FALSE) %>%
  add_header_above(c(" " = 1, "Week 1" = 2, "Week 2" = 2, "Week 3" = 2, "Week 4" = 2, "Week 5" = 2, "Week 6" = 2)) %>%
...
pptotal <- pptotal %>%
  mutate(PrePollWeek = case_when(
    ...
    ReportingPeriodName == "Pre-Poll 4 - Party(20/06/24 - 26/06/24) UKPGE 2024" ~ "week four",
    ReportingPeriodName == "Pre-Poll 4 - Party(27/11/19 - 03/12/19) UKPGE 2019" ~ "week four",
    ReportingPeriodName == "Pre-Poll 5 - Party(04/12/19 - 10/12/19) UKPGE 2019" ~ "week five",
    ReportingPeriodName == "Pre-Poll 5 - Party(27/06/24 - 03/07/24) UKPGE 2024" ~ "week five",
    ReportingPeriodName == "Pre-Poll 6 - Party(04/07/24 - 04/07/24) UKPGE 2024" ~ "week six",
    ReportingPeriodName == "Pre-Poll 6 - Party(11/12/19 - 12/12/19) UKPGE 2019" ~ "week six",
...
pptotal <- pptotal %>%
  mutate(Year = case_when(
    ...
    ReportingPeriodName == "Pre-Poll 4 - Party(20/06/24 - 26/06/24) UKPGE 2024" ~ "2024",
    ReportingPeriodName == "Pre-Poll 4 - Party(27/11/19 - 03/12/19) UKPGE 2019" ~ "2019",
    ReportingPeriodName == "Pre-Poll 5 - Party(04/12/19 - 10/12/19) UKPGE 2019" ~ "2019",
    ReportingPeriodName == "Pre-Poll 5 - Party(27/06/24 - 03/07/24) UKPGE 2024" ~ "2024",
    ReportingPeriodName == "Pre-Poll 6 - Party(04/07/24 - 04/07/24) UKPGE 2024" ~ "2024",
    ReportingPeriodName == "Pre-Poll 6 - Party(11/12/19 - 12/12/19) UKPGE 2019" ~ "2019",
    TRUE ~ ReportingPeriodName
  ))

# setting factor levels for week

pptotal$PrePollWeek <- factor(pptotal$PrePollWeek, level = c("week one", "week two", "week three", "week four", "week five", "week six"))
...
kable(year_summary_wide, col.names = c("", "2019", "2024", "2019", "2024", "2019", "2024", "2019", "2024", "2019", "2024", "2019", "2024", "2019", "2024"), align = 'c') %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = FALSE) %>%
  add_header_above(c(" " = 1, "Individual" = 2, "Company" = 2, "Trade Union" = 2, "Political Party" = 2, "Unincorporated Association" = 2, "Friendly Society" = 2, "LLP" = 2)) %>%
